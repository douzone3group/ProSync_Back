...
//        http.headers().frameOptions().disable();
        ...
        http
                .authorizeRequests()
                .mvcMatchers("/api/v1/members","/api/v1/login", "/api/v1/send_verification","/api/v1/verify_code", "/api/v1/idcheck").permitAll()
                ...
                .mvcMatchers("/api/v1/subscribe/**", "/api/v1/bookmark/**").permitAll()
