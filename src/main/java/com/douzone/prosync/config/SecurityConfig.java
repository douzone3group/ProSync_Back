...
//        http.headers().frameOptions().disable();
        ...
        http
                .authorizeRequests()
                .mvcMatchers("/api/v1/members","/api/v1/login", "/api/v1/send_verification","/api/v1/verify_code","/v2/api-docs","/favicon.ico","/swagger-ui/index.html").permitAll()
                .antMatchers("/**/*.css", "/**/*.js", "/**/*.png","/swagger-ui/**","/swagger-resources/**")
                .permitAll()
                .anyRequest().authenticated();
