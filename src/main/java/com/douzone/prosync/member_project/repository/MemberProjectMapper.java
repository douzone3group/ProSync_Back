...
public interface MemberProjectMapper {
    ...
    Integer saveProjectMember(@Param("memberId") Long memberId, @Param("projectId") Integer projectId);
    ...
    Optional<MemberProjectResponseDto> findProjectMember(@Param("projectId") Integer projectId, @Param("memberId") Long memberId);
    ...
    void exitProjectMember(@Param("projectId") Integer projectId, @Param("memberId") Long memberId);

    @Select("select project_id from member_project where member_project_id = #{projectMemberId}")
    Integer findProjectByProjectMemberId(Long projectMemberId);

    @Insert("insert into member_project(project_id, member_id, authority_id) values(#{projectId}, #{memberId}, 3)")
    Integer saveProjectAdmin(@Param("projectId") Integer projectId, @Param("memberId") Long memberId);
